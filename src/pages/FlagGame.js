...
function FlagGame() {
  ...
  return (
    <div className="p-6 text-center bg-gray-50 dark:bg-gray-900 min-h-screen transition-colors duration-300">
      <h1 className="text-3xl font-bold mb-6 text-gray-800 dark:text-gray-200">{t('flagGuessingGame')}</h1>
      ...
      {currentCountry.flags?.png && (
        <div className="mb-8">
          <img
            ...
            alt="Country flag"
            className="w-64 h-40 mx-auto border-4 border-gray-200 dark:border-gray-600 rounded-xl shadow-lg"
            onError={(e) => {
              e.target.style.display = 'none';
            }}
          />
